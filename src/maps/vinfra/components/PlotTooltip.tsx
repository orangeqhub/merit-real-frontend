...
/**
 * Floating hover tooltip, matching the visual pattern already established
 * across the other Merit interactive layouts (white card, rounded
 * corners, subtle shadow, bold green plot number). Mandira has no
 * booking/customer backend of its own, so facing/rate/cost fall back to
 * "-" and status defaults to "Available" rather than being invented.
 */
