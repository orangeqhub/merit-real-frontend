 ...
 * matching the pattern used by merit-dokiparru's App.tsx -- the host page's
 * own layout can resize this container without `window` ever firing a
 * resize event, which would otherwise leave the SVG's width/height stale.
 */
