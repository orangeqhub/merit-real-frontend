...
// Satellite/aerial basemap (Esri World Imagery) — same source used by
// merit-srilakshmi's GISMap.tsx, no API key required. Swap this one URL to
// change basemap style; nothing else in the georeferencing or
// vector-overlay path depends on it.
const IMAGERY_URL =
