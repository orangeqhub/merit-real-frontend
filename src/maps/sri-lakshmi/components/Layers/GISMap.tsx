...
// Satellite/aerial basemap (Esri World Imagery) — matches
// merit-map-layout-main's GISMap.tsx exactly, no API key required. Swap
// this one URL to change basemap style; nothing else in the georeferencing
// or vector-overlay path depends on it.
const IMAGERY_URL =
