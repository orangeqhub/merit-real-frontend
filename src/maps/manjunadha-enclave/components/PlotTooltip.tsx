...
/**
 * Hover tooltip. Manjunadha's source brochure prints no per-plot
 * facing/status/rate/cost, so those fields fall back to "-"/"Available"
 * rather than being invented (same convention as the reference apps).
 */
const PlotTooltip: FC<Props> = ({ plot, x, y }) => {
  ...
  return (
    ...
    >
      <div style={{ fontWeight: "bold", color: "#2E7D32" }}>Plot {plot.plotNumber}</div>
