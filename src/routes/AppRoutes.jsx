...
import MapLayouts from '../pages/public/MapLayouts';
    ...
    <Suspense fallback={<RouteLoadingFallback />}>
      <Routes>
        <Route element={<PublicLayout />}>
          ...
          <Route path="/map-layouts" element={<MapLayouts />} />
          <Route path="/map-layout" element={<Navigate to="/map-layouts" replace />} />
          <Route path="/map-layout/:layoutKey" element={<MapLayoutPage />} />
